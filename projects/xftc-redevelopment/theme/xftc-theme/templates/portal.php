...
if ( ! is_user_logged_in() ) {
    ...
    <div class="container" style="padding-block:4rem;text-align:center;">
        ...
        <p style="color:var(--xftc-gray-600);margin-bottom:2rem;">Please log in to access your athlete dashboard.</p>
        <?php echo do_shortcode( '[xftc_login_form]' ); ?>
    ...
    <section class="section" style="padding-top:1.5rem;">
        <div class="container">
            ...
            <div id="tab-athletes">
                <?php echo do_shortcode( '[xftc_my_athletes]' ); ?>
            </div>

            <div id="tab-schedule" style="display:none;">
                <?php echo do_shortcode( '[xftc_my_schedule show_register="true"]' ); ?>
            </div>

            <div id="tab-results" style="display:none;">
                <?php echo do_shortcode( '[xftc_my_results show_chart="true"]' ); ?>
            </div>

            <div id="tab-payments" style="display:none;">
                <?php echo do_shortcode( '[xftc_my_payments show_receipts="true"]' ); ?>
            </div>

            <div id="tab-travel" style="display:none;">
                <?php echo do_shortcode( '[xftc_my_travel]' ); ?>
            </div>
