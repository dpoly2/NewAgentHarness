...
<?php if ( class_exists( 'PBS_ProfilePress' ) && PBS_ProfilePress::profilepress_active() ) : ?>
  ...
  <div class="pbs-section-body" style="padding:0 20px 20px">
    <table class="form-table" style="margin-top:12px">
      <tr>
        ...
        <td>
          <?php
          // Use the safe helper — never call PlanFactory::get_plans() directly (not available in all PP versions)
          $default_plan_id = (int) get_option( 'pbs_pp_default_grant_plan', 0 );
          $all_plans       = PBS_ProfilePress::get_all_plans_public();
          ?>
          ...
          <p class="description">
            ...
            Defaults to <strong>Do Not Grant</strong>. Enrollments only happen per-event or if set here.
            <strong>Note:</strong> Donations are never enrolled regardless of this setting.
          </p>
        </td>
      </tr>
    </table>
