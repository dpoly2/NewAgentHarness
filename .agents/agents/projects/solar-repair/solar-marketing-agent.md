...
### Referral Program
- Partner with solar installers who don't offer repair (refer their old customers)
- Partner with roofing companies — solar penetration leaks are common cross-referrals
- Partner with home inspectors — they flag solar issues during home sales

### Brand Strategy
- Position as "The solar repair specialist" — not an installer who also repairs
- Trust signals: licensed, insured, TDLR-registered, Hert Renewables certified partner
- Photo/video content: before/after repairs, diagnostic process, team on rooftop

## Immediate Actions
- [ ] Confirm company name with David
- [ ] Register domain + matching social handles
- [ ] Brief S2T Designs on logo and brand kit
- [ ] Set up Google Business Profile
- [ ] Build 5-page website (Home, Services, About, Service Area, Contact)
- [ ] Draft first 3 social posts for launch
